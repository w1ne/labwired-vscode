...
exports.SimulatorViewProvider = void 0;
const vscode = require("vscode");
const simulatorManager_1 = require("./simulatorManager");
class SimulatorViewProvider {
    constructor(manager) {
    ...
    getChildren(element) {
        ...
        // Actions
        if (this.manager.status === simulatorManager_1.SimulatorStatus.Stopped || this.manager.status === simulatorManager_1.SimulatorStatus.Error) {
    ...
    getIconForStatus(status) {
        switch (status) {
            case simulatorManager_1.SimulatorStatus.Running:
                return new vscode.ThemeIcon('pass-filled', new vscode.ThemeColor('testing.iconPassed'));
            case simulatorManager_1.SimulatorStatus.Error:
...
exports.SimulatorViewProvider = SimulatorViewProvider;
//# sourceMappingURL=simulatorView.js.map
